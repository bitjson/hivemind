...
This document provides guidelines for internationalization of the Hivemind Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `hivemind_en.ts` remains unchanged.
