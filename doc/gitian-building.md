...
in the hivemind repository under 'Fetch and build inputs' to install sources which require
...
Output from `gbuild` will look something like
    ...
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/hivemind/.git/
    remote: Counting objects: 57959, done.
    remote: Total 57959 (delta 0), reused 0 (delta 0), pack-reused 57958
    Receiving objects: 100% (57959/57959), 53.76 MiB | 484.00 KiB/s, done.
    Resolving deltas: 100% (41590/41590), done.
    From https://github.com/bitcoin-hivemind/hivemind/
...
and the hivemind git repository with the desired tag must both be available locally, and then gbuild must be
...
LXC_ARCH=amd64 LXC_SUITE=precise on-target -u root \
  ...
  $( sed -ne '/^packages:/,/[^-] .*/ {/^- .*/{s/"//g;s/- //;p}}' ../hivemind/contrib/gitian-descriptors/*|sort|uniq )
...
cd /some/root/path/
git clone https://github.com/bitcoin-hivemind/hivemind-detached-sigs.git

BTCPATH=/some/root/path/hivemind.git
SIGPATH=/some/root/path/hivemind-detached-sigs.git

./bin/gbuild --url hivemind=${BTCPATH},signature=${SIGPATH} ../hivemind/contrib/gitian-descriptors/gitian-win-signer.yml
```
