...
[doc/release-process.md](release-process.md#fetch-and-build-inputs-first-time-or-when-dependency-versions-change)
in the hivemind repository to install sources which require manual intervention. Also follow
