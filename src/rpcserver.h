...
extern json_spirit::Value importvoteprivkey(const json_spirit::Array& params, bool fHelp);
...
extern json_spirit::Value getbranchaddress(const json_spirit::Array& params, bool fHelp);
